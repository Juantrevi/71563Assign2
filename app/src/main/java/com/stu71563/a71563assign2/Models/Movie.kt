...
val movieList = listOf(
    Movie("IMMACULATE",
        ...
        "Suitable only for customers aged 16 years and over. Please remember to bring a valid, photographic ID.",
    ...
    Movie("BOB MARLEY: ONE LOVE",
        ...
        "Films classified 12A are generally not suitable for children aged under 12. No one younger than 12 may see a 12A film unless accompanied by an adult.",
    ...
    Movie("IMAGINARY",
        ...
        "Films classified 15A are generally not suitable for children aged under 15. No one younger than 15 may see a 15A film unless accompanied by an adult.",
